...
/**
 * DeveloperDto 클래스는 개발자 정보를 담는 DTO(Data Transfer Object) 클래스이다.
...
public class DeveloperDto {
    ...
    // Developer 엔티티 객체를 DeveloperDto 객체로 변환하는 메서드이다.
    public static DeveloperDto fromEntity(Developer developer) {
        // Developer 엔티티의 각 필드를 DeveloperDto 객체의 필드에 매핑하여 반환한다.
